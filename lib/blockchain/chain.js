...
class Chain extends AsyncEmitter {
  ...
  async getDeployments(time, prev) {
    ...
    // Cuckoo Proof-of-Work Hard Fork Activated.
    if (timestamp >= this.network.block.cuckooBlock) {
      state.cuckooBlock = true;
    }
  ...
  async getTarget(time, prev) {
    ...
    // New Proof-of-Work introduced.
    // TODO: DigiSheild / Targetting algorithm
