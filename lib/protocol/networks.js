...
main.pow = {
  ...
  /**
   * Minimum Cuckoo Parameter set.
   * @const {Number}
   * @default
   */

  minActual: ((5100 * (100 - 16)) / 100) >>> 0,

  /**
   * Maximum Cuckoo Parameter set.
   * @const {Number}
   * @default
   */

  maxActual: ((5100 * (100 + 32)) / 100) >>> 0,
...
main.block = {
  ...
  /*
   * Unix timestamp which Hard Fork occurs
   */

  cuckooBlock: 1548650000
};
